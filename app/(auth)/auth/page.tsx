  ...
  return (
    <div className='flex min-h-screen mt-7'>
        <div className='w-full max-w-3xl mx-auto flex flex-col lg:flex-row p-3'>
            ...
            onClick={() => router.push('/')}
            >
                <ChevronLeft className='text-grey-500 h-6 w-6 sm:h-8 sm:w-8 border-2 rounded-full p-1'/>
            </div>
            ...
            <p className='text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8'>
              {isSignUp
                ? 'Join Store today and discover exclusive deals on your favorite products!'
                : 'Welcome back to Store! Log in to continue your shopping journey.'}
            </p>
          </div>
                 {/* Toggle form */}
